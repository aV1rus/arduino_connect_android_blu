...
import av1rus.arduinoconnect.Main;
...
public class PresetsFragment extends Fragment {  
	ArrayList<CheckBox> presetBoxs;
     ...
     public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) { 
		...
		String[] titles = {"Emergency 1", "Emergency 2", "Emergency 3", "Emergency 4", "Only White", "Only Red", "HeartBeat Red", "HeartBeat White", "Follow RPM Mix", "Follow RPM Red", "Follow RPM White", "Follow RPM Red Smooth", "Follow RPM White Smooth"};
		int[] colors = {Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE};
		final String[] sendActions = {Emergency1, Emergency2, Emergency3, Emergency4, Emergency3OnlyWhite, Emergency4OnlyRed, HeartBeatRed, HeartBeatWhite, FollowRPMMix, FollowRPMRed, FollowRPMWhite, FollowRPMRedSmooth, FollowRPMWhiteSmooth};
