	...
	public void handleReceived(ArrayList<String> commands) {
		...
		if (BluetoothService.isConnected) {
			...
			for (int i = 0; i < commands.size(); i++) {
				...
				if (
                        command.contains("halos") || command.contains("halo") ||
                        command.contains("hallows") || command.contains("hollows") ||
                        command.contains("weapons") || command.contains("weapon") ||
                        command.contains("hey lowes") || command.contains("hey low") ||
                        (command.contains("he") && command.contains("was") )
                    ) { // Is halo command
